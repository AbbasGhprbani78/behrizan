const fa = {
    ...
    textmaxchat: "از صحبت با شما لذت بردم! برای کمک به بهتر شدن سرویس و ارائه راهنمایی‌های بیشتر، چت ما به ۱۰ سوال محدود شده است. اگر نیاز به اطلاعات بیشتری دارید، می‌توانید یک چت جدید شروع کنید. خوشحال می‌شم دوباره کمکتون کنم!",
    newChat: "چت جدید"
}
