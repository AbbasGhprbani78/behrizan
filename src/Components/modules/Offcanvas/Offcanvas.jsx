...
export default function OffcanvasSideBar({ show, onHide }) {
  ...
  const phoneNumber =
    language === "fa"
      ? toPersianDigits(socaial?.phone_number)
      : socaial?.phone_number;
  ...
  return (
    <>
      <Offcanvas
        show={show}
        onHide={onHide}
        className={`offcanvas ${language === "fa" && "rtl"}`}
        placement={language === "fa" ? "end" : "start"}
      >
            ...
            <ul className="menu-sidebar-list">
              ...
              >
                <svg
                  ...
                  height="25px"
                  fill="currentColor"
                  className="bi bi-basket2-fill cart-icon icon-menu-sidebar"
                  viewBox="0 0 16 16"
                >
              ...
              >
                <svg
                  ...
                  height="25px"
                  fill="currentColor"
                  className="bi bi-cup-hot icon-menu-sidebar"
                  viewBox="0 0 16 16"
                >
                  <path
                    fill-rule="evenodd"
                ...
                <span className="sidebar-text">{t("MENU")}</span>
              </NavLink>
              <NavLink
                className="sidebar-item"
                onClick={onHide}
              ...
              <div className="sidebar-change-languge">
                <p
                  className={`btn-change-la change-en ${isEn && "lang-active"}`}
                  onClick={changeLanguageToEn}
                >
                  EN
                </p>
                <p
                  className={`btn-change-la change-fa ${isFa && "lang-active"}`}
                  onClick={changeLanguageToFa}
                >
                  FA
                </p>
              </div>
              <div className="location-wrapper">
                <span>
                  <FmdGoodOutlinedIcon className="locicon-sidebar" />
                </span>
                {language === "fa" ? (
                  ...
                  <p className="text-loction">{socaial?.address}</p>
                )}
              </div>
            </ul>
          </div>
