    ...
    return (
      <>
        ...
        {windowWidth < 1025 ? (
          <>
            <header
              className={`header-container-m ${language === "fa" && "rtl"} ${
                scrollY > 0 ? "fixed-header" : ""
              }`}
            >
                      ...
                      <div className="link-menu-tab">
                        <ul className="link-menu-tab-list">
                          <li className="nav-list-item">
                            ...
                            <NavLink className="navlink-nav" to={"/"}>
                              {t("HOME")}
                            </NavLink>
                          </li>
                          <li className="nav-list-item">
                          ...
                          <li className="nav-list-item">
                            ...
                            <NavLink className="navlink-nav" to={"/aboutus"}>
                              {t("STORY")}
                            </NavLink>
                          </li>
                        </ul>
                      ...
                      <div className="right-menu-tab">
                        ...
                        <div className="switch mx-4">
                          <div className="change-languge d-flex align-items-center">
                            <p
                              className={`btn-change-la change-en ${
                                isEn && "lang-active"
                              }`}
                            ...
                            <p
                              className={`btn-change-la change-fa mx-2 ${
                                isFa && "lang-active"
                              }`}
          ...
          <>
            <header
              className={`header-container ${language === "fa" && "rtl"} ${
                scrollY > 0 ? "fixed-header" : ""
              }`}
            >
              <nav className="header-nav">
                <div className="left-nav">
                  ...
                  <ul className="nav-list">
                    ...
                    <li className="nav-list-item">
                      <NavLink className="navlink-nav" to={"/categorymenus"}>
                        {t("MENU")}
                      </NavLink>
                    </li>
                    <li className="nav-list-item">
                ...
                <div className="right-nav">
                    ...
                    >
                      <svg
                        ...
                        height="18"
                        fill="currentColor"
                        className="bi bi-basket2-fill cart-icon"
                        viewBox="0 0 16 16"
                      >
